...
export function MonthRangeFilter(props: { monthKeys: string[] }) {
  const { monthKeys } = props;
  ...
  // store internal Select values (no empty string for radix items)
  ...
  function apply() {
    ...
    params.set("period", currentPeriod === "overall" ? "overall" : "monthly");
